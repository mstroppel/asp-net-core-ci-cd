...
Edit `infra/main.bicepparam` if you want a different web app name or region — it's the single source of truth, also consumed by the GitHub Actions deploy workflow.
